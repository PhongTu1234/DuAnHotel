...
CREATE TABLE Hotels (
    ...
    description nvarchar(255),                       -- Mô tả về khách sạn
...
CREATE TABLE Feedback (
	...
	updated_at BIGINT,						 --Thời gian chỉnh sửa
	FOREIGN KEY (hotel_id) REFERENCES Hotels(hotel_id),
	FOREIGN KEY (Id) REFERENCES Authorities(Id)
);
go
...
insert into HOTELTYPES values   (1, 0.0, 1694272166, 1694272231),
								(2, 1.0, 1694272166, 1694272231),
								(3, 2.0, 1694272166, 1694272231),
								(4, 3.0, 1694272166, 1694272231),
								(5, 4.0, 1694272166, 1694272231),
								(6, 5.0, 1694272166, 1694272231)
								

insert into Hotels values   (1, 'Thuy Van Hotel', N'10 Quang Trung phường 1 thành phố Đà Lạt', '012-345-6789', 'tuannhps21725@gmail.com', N'Sang Trong, đẹp đẽ', N'Free wifi,													security', 4.5, 1, 1, 1, 1694272166, 1694272231),
							...
							(6, 'Lakeview Retreat', '200 Lakeside Drive, Countryside', '888-555-1234', 'tuannhps21725@gmail.com', 'Tranquil retreat with lakeside views', 'Fishing, Kayaking, Spa', 4.7, 9, 5, 1,	1694272166, 1694272231),
							...
							(8, 'Tropical Paradise Resort', '789 Palm Beach, Tropical Island', '123-555-7890', 'tuannhps21725@gmail.com', 'Exotic resort surrounded by palm trees', 'Beachfront, Poolside Cabanas', 4.6, 1, 6, 1, 1694272166, 1694272231),
							...
							(10, 'Luxury Suites', '500 Highrise Avenue, City', '555-888-2222', 'tuannhps21725@gmail.com', 'Elegant suites with city skyline views', 'Spa, Gourmet Dining', 4.8, 10, 5, 1, 1694272166, 1694272231),
							(11, 'Countryside Farmstay', '600 Farm Road, Countryside', '555-222-4444', 'tuannhps21725@gmail.com', 'Experience farm life in the countryside', 'Farm Tours, Fresh Produce', 4.2, 9, 4, 1, 1694272166, 1694272231),
							(12, 'Sunset Beach Resort', '700 Sunset Boulevard, Coastal Town', '555-444-6666', 'tuannhps21725@gmail.com', 'Picturesque resort with stunning sunsets', 'Beachfront, Beach Bar', 4.9, 9, 3, 2, 1694272166, 1694272231),
							(13, 'Rustic Cabins', '800 Woodsy Lane, Forest', '555-666-8888', 'tuannhps21725@gmail.com', 'Rustic cabins nestled in the forest', 'Nature Trails, Campfire', 3.9, 7, 3, 5, 1694272166, 1694272231),
							...
							(15, 'Coastal Clifftop Villas', '1000 Clifftop Road, Coastal Town', '555-111-3333', 'tuannhps21725@gmail.com', 'Villas with breathtaking coastal views', 'Clifftop Pool, Seafood Restaurant', 4.7, 10, 4, 1,	1694272166, 1694272231),
							...
							(17, 'Mountain Adventure Lodge', '1200 Adventure Road, Mountains', '555-222-4444', 'tuannhps21725@gmail.com', 'Lodge for outdoor enthusiasts', 'Hiking, Rock Climbing', 4.2, 7, 2, 5, 1694272166, 1694272231),
							(18, 'Desert Oasis Resort', '1300 Oasis Boulevard, Desert', '555-444-6666', 'tuannhps21725@gmail.com', 'Resort in the middle of the desert', 'Swimming Pool, Desert Safari', 4.3, 4, 5, 3, 1694272166, 1694272231),
							(19, 'Riverfront Retreat', '1400 River Road, Riverside', '555-666-8888', 'tuannhps21725@gmail.com', 'Relax by the river at this peaceful retreat', 'Fishing, Riverside Dining', 4.1, 3, 6, 4, 1694272166, 1694272231),
							...
							(28, 'Tropical Jungle Resort', '2400 Jungle Avenue, Rainforest', '555-444-6666', 'tuannhps21725@gmail.com', 'Immerse yourself in the tropical rainforest', 'Jungle Treks, Canopy Walk', 4.2, 6, 1, 1,	1694272166, 1694272231),
							(29, 'Country Cottage Inn', '2500 Cottage Road, Countryside', '555-666-8888', 'tuannhps21725@gmail.com', 'Quaint country cottages for a cozy stay', 'Homemade Breakfast, Country Views', 4.0, 7, 3, 3, 1694272166, 1694272231),
							...
							(36, 'Savannah Colonial Inn', '3200 Colonial Avenue, Historic District', '555-888-2222', 'tuannhps21725@gmail.com', 'Stay in a colonial-style inn in historic Savannah', 'Southern Hospitality, Colonial Decor', 4.2, 2, 2, 4, 1694272166, 1694272231),
...
insert into RoomTypes values (1, N'Standard', 1694272166, 1694272231),
							 (2, 'Beachfront', 1694272166, 1694272231),
							 (3, 'Deluxe', 1694272166, 1694272231),
							 (4, 'Suite', 1694272166, 1694272231),
							 (5, 'Family', 1694272166, 1694272231),
							 (6, 'Executive', 1694272166, 1694272231),
							 (7, 'Bungalow', 1694272166, 1694272231),
							 (8, 'Penthouse', 1694272166, 1694272231),
							 (9, 'Villa', 1694272166, 1694272231),
							 (10, 'Cottage', 1694272166, 1694272231)
...
insert into Booking_room values (1, 1, 10, 1694272166, 1694272231),
								(2, 5, 20, 1694272166, 1694272231),
								(3, 10, 30, 1694272166, 1694272231),
								(4, 15, 40, 1694272166, 1694272231),
								(5, 20, 50, 1694272166, 1694272231),
								(6, 25, 60, 1694272166, 1694272231),
								(7, 30, 70, 1694272166, 1694272231),
								(8, 35, 80, 1694272166, 1694272231),
								(9, 40, 90, 1694272166, 1694272231),
								(10, 45, 110, 1694272166, 1694272231),
								(11, 50, 120, 1694272166, 1694272231),
								(12, 11, 130, 1694272166, 1694272231),
								(13, 21, 140, 1694272166, 1694272231),
								(14, 31, 150, 1694272166, 1694272231),
								(15, 41, 160, 1694272166, 1694272231),
								(16, 46, 170, 1694272166, 1694272231),
								(17, 16, 180, 1694272166, 1694272231),
								(18, 26, 190, 1694272166, 1694272231),
								(19, 36, 200, 1694272166, 1694272231)
